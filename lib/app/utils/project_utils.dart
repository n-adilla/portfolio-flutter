...
List<ProjectUtils> projectUtils = [
  ProjectUtils(
    ...
    links: 'https://github.com/Adillanb/poetically-.git',
  ),
  ProjectUtils(
    ...
    links: 'https://github.com/Adillanb/',
  ),
  ProjectUtils(
    ...
    links: 'https://github.com/Adillanb/elderly_exercise_app.git',
  ),
  ProjectUtils(
    ...
    links: 'https://github.com/Adillanb/flutter_plant_app.git',
  ),
];
